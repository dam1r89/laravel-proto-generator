...
@section('title','Create new __ ucfirst($singleItem)__')
@section('breadcrumb', HTML::linkRoute('__$collection__.index', 'All __ ucfirst($collection)__'))
@section('h1','Create new __ ucfirst($singleItem)__')
    ...
    @include('proto._adminbuttons')
        ...
        <div class="portlet box  {!! $site_settings["portlet_color"] or 'blue-hoki' !!} ">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-user"></i> Create new __ ucfirst($singleItem)__
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <div class="form-body">
    {!!Form::model($__$item__,[ 'route' => '__$collection__.store' ,'role'=>'form','class'=>'form-horizontal','files'=> true])!!}
                ...
                __!foreach($fields as $field):__
                    __!if($field->has('translation')):__
                            <div class="form-group {{ ($errors->has($lang.'.__$field__')) ? 'has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text($lang.'[__$field__]', null, array('class' => 'form-control', 'placeholder' => '__ ucfirst($field) __')) !!}
        ...
        __!if(!$field->has('translation')):__
            __!if($field->has('relation')) : __ 
                    ...
                    <div class="form-group {{ ($errors->has('__$field__')) ? 'has-error' : '' }}">
                        <label class="col-md-3 control-label">__ ucfirst($field->get("relation")["name"])__</label>
                        <div class="col-md-9">
                            {!! Form::select('__$field__[]', __$field->get("relation")["class"]__::all()->lists('__$field->get("relation")["field"]__','id'),null, array('class' => 'form-control select2', 'placeholder' => '__ ucfirst($field) __','multiple')) !!}
                            {!! ($errors->has('__$field__') ? '<p>'.$errors->first('__$field__').'</p>' : '') !!}
                        </div>
                    </div>
                     __!endif__
